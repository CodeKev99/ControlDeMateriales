...
public class Succes extends javax.swing.JDialog {
    ...
    public Succes(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/iconos/success.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Succes dialog = new Succes(new javax.swing.JFrame(), true);
