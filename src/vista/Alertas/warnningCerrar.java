 ...
 * @author Kevin
 */
public class warnningCerrar extends javax.swing.JDialog {
    ...
    public warnningCerrar(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(warnningCerrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                warnningCerrar dialog = new warnningCerrar(new javax.swing.JFrame(), true);
